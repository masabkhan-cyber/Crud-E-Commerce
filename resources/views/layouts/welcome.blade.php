      ...
      <section class="">
        ...
        <div class="row">
          ...
          <div class="col-md-3 col-lg-3 col-xl-3 mx-auto mt-3">
            ...
            {{ config('website-settings.website_name') }}.
            </h6>
            <p>
          ...
          <div class="col-md-4 col-lg-3 col-xl-3 mx-auto mt-3">
            ...
            <p><i class="fas fa-envelope mr-3"></i> {{ config('website-settings.email') }}</p>
            <p><i class="fas fa-phone mr-3"></i> {{ config('website-settings.phone_number') }}</p>
          </div>
          <!-- Grid column -->
        </div>
        <!--Grid row-->
      ...
      <section class="p-3 pt-0">
        <div class="row d-flex align-items-center">
          ...
          <div class="col-md-7 col-lg-8 text-center text-md-start">
            <!-- Copyright -->
            <div class="p-3">
            &copy; {{ date('Y') }} {{ config('website-settings.website_name') }}. All rights reserved.
            </div>
            <!-- Copyright -->
          </div>
          <!-- Grid column -->
